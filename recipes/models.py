...
class User(AbstractUser):
    ...
    bio = models.TextField(blank=True, null=True, help_text="Short biography or introduction about the user.")
...
class Recipe(models.Model):
    ...
    """
    title = models.CharField(max_length=100, help_text="Enter the title of the recipe.")
...
class Collection(models.Model):
    ...
    """
    name = models.CharField(max_length=100, help_text="Name of the collection.")
