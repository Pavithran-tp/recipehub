    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_featured', models.BooleanField(default=False, help_text='Designates whether this recipe is featured (managed by an admin).')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_unit', models.CharField(blank=True, help_text='A custom unit if not in the predefined list.', max_length=50, null=True)),
